<?php
	...
	$app_lang['invalid_mobile_number']="Invalid Mobile Number Try Again!";

	// for email not found
	$app_lang['email_not_found']="Email is not found !";

	$app_lang['user_not_found']="User not found !";
	...
	$app_lang['account_invalid']="Sorry ! Your account is invalid";

	// for lagin success
	$app_lang['login_success']="Login successfully...";
	// for mobile exist
	$app_lang['phone_exist']="Mobile Number is already exist !";
