    ...
    if(!filter_var($_POST['email'], FILTER_VALIDATE_EMAIL))
    {
        ...
        if(mysqli_num_rows($res) == 0){
            $data = array(
                ...
                'account_holder_name'  => filter_var($_POST['account_holder_name'], FILTER_SANITIZE_STRING),
                'linked_mobile'  => filter_var($_POST['linked_mobile'], FILTER_SANITIZE_STRING),
            );
                            ...
                            <form action="" method="post" class="form form-horizontal" enctype="multipart/form-data">
                                <div class="section">
                                    <div class="section-body">
                                        ...
                                        <?php if($user_row['account_number'] AND $user_row['ifsc_code'] AND $user_row['account_holder_name'] AND $user_row['linked_mobile']){?>
                                            <div id="account_details" >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="text" name="account_number" id="account_number" value="<?php if(isset($_GET['user_id'])){echo stripslashes($user_row['account_number']);}?>" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label">IFSC Code :-</label>
                                                    <div class="col-md-6">
                                                        <input type="text" name="ifsc_code" id="ifsc_code" value="<?php if(isset($_GET['user_id'])){echo stripslashes($user_row['ifsc_code']);}?>" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label">Account Holder Name :-</label>
                                                    <div class="col-md-6">
                                                        <input type="text" name="account_holder_name" id="account_holder_name" value="<?php if(isset($_GET['user_id'])){echo stripslashes($user_row['account_holder_name']);}?>" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label">Linked Mobile :-</label>
                                                    <div class="col-md-6">
                                                        <input type="text" name="linked_mobile" id="linked_mobile" value="<?php if(isset($_GET['user_id'])){echo stripslashes($user_row['linked_mobile']);}?>" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                        <?php }?>
