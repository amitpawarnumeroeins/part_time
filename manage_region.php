...
if (isset($_POST['search'])) {
    ...
    $region_qry = "SELECT tbl_region.*,tbl_country.name as country_name FROM tbl_region,tbl_country WHERE tbl_country.id = tbl_region.country_id AND  tbl_region.`name` LIKE '%$keyword%' ORDER BY tbl_region.`id` DESC";

    $result = mysqli_query($mysqli, $region_qry);

} else {

    $tableName = "tbl_region";
    $targetpage = "manage_region.php";
    $limit = 15;
    ...
    $region_qry = "SELECT tbl_region.*,tbl_country.name as country_name FROM tbl_region,tbl_country WHERE tbl_country.id = tbl_region.country_id  
		 ORDER BY tbl_region.`id` DESC LIMIT $start, $limit";
        ...
        <div class="card mrg_bottom">
            <div class="page_title_block">
                <div class="col-md-5 col-xs-12">
                    <div class="page_title">Manage Region</div>
                </div>
                <div class="col-md-7 col-xs-12">
                    <div class="search_list">
                        ...
                        <div class="add_btn_primary"> <a href="add_region.php?add">Add Region</a> </div>
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="add_region.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn_cust" data-toggle="tooltip" data-tooltip="Edit"><i class="fa fa-edit"></i></a>
