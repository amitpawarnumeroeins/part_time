...
<body>
  ...
  <div class="app app-default">
    ...
    <aside class="app-sidebar" id="sidebar">
      ...
      <div class="sidebar-header"> <a class="sidebar-brand" href="home.php"><img src="images/logo-part-time.png" alt="app logo" /></a>
...
<!--          <?php /*if (file_exists('api.php') or (file_exists('ios_api.php'))) { */?>
    ...
    <div class="app-container">
      ...
      <nav class="navbar navbar-default" id="navbar" style="padding: 0;border: 0px">
