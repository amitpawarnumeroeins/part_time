...
$qry_users = "SELECT COUNT(*) as num FROM tbl_users WHERE id <> 0 AND status = 2";
...
<div class="row">
  ...
  <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12"> <a href="manage_category.php" class="card card-banner card-green-light">
  ...
  <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12"> <a href="manage_city.php" class="card card-banner card-blue-light">
  ...
  <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12"> <a href="manage_jobs.php" class="card card-banner card-yellow-light">
  ...
  <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12"> <a href="manage_users.php" class="card card-banner card-orange-light">
